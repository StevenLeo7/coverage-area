...
<div class="main-grid">
    <div class="agile-grids">	
        ...
        <form action="<?php echo e(url('/chart_request_2')); ?>" method="post" id="myform" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>   
            <div class="row">
                <div class="col-lg-12">
                    <div class="col-lg-4">
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\backupcoveragearea\resources\views/coverage_internal/chart_request_2.blade.php ENDPATH**/ ?>